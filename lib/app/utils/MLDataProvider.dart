import 'package:epasien/app/data/MLAppointmentData.dart';
import 'package:epasien/app/data/MLBookAppointmentData.dart';
import 'package:epasien/app/data/MLCovidData.dart';
import 'package:epasien/app/data/MLDeliveredData.dart';
import 'package:epasien/app/data/MLDepartmentData.dart';
import 'package:epasien/app/data/MLDiseaseData.dart';
import 'package:epasien/app/data/MLDoctorData.dart';
import 'package:epasien/app/data/MLInboxData.dart';
import 'package:epasien/app/data/MLMedicationData.dart';
import 'package:epasien/app/data/MLNewsData.dart';
import 'package:epasien/app/data/MLNotificationData.dart';
import 'package:epasien/app/data/MLOrderSuccessData.dart';
import 'package:epasien/app/data/MLOrderTrackData.dart';
import 'package:epasien/app/data/MLPatientData.dart';
import 'package:epasien/app/data/MLPaymentData.dart';
import 'package:epasien/app/data/MLProfileCardData.dart';
import 'package:epasien/app/data/MLServiceData.dart';
import 'package:epasien/app/data/MLSpecialistData.dart';
import 'package:epasien/app/data/MLTopHospitalData.dart';
import 'package:epasien/app/data/MLVoucherData.dart';
import 'package:epasien/app/data/MLWalkThroughData.dart';
import 'package:epasien/app/modules/halaman_booking/components/MLClinicVisitComponent.dart';
import 'package:epasien/app/modules/halaman_booking/components/MLConfirmAppointmentComponent.dart';
import 'package:epasien/app/modules/halaman_booking/components/MLPenjabComponent.dart';
...
List<MLServicesData> mlServiceDataList() {
  ...
  list.add(MLServicesData(
      ...
      widget: Routes.PENGADUAN));
  list.add(MLServicesData(
      title: 'Dokter',
      icon: Icons.local_hospital,
      image: ml_ic_dashPharmacy,
      widget: Routes.JADWAL_DOKTER));
  list.add(MLServicesData(
      title: 'Fasilitas & Tarif',
      icon: Icons.health_and_safety,
      image: 'images/hospital-facility.png',
      widget: Routes.FASILITAS_TARIF));
  list.add(MLServicesData(
      title: 'Kamar',
      icon: Icons.supervised_user_circle_outlined,
      image: 'images/hospital-bed.png',
      widget: Routes.KEDERSEDIAAN_KAMAR));
  return list;
}
